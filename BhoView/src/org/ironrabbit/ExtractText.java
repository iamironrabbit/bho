...
public class ExtractText {
	public static String extract (String sourceUrlString) throws MalformedURLException, IOException
	{
		String result = "";
	...
	//	result = getContent(source);
		
			TextExtractor te = source.getTextExtractor();
			te.setIncludeAttributes(false);
	...
	private static String getContent(Source source) {
		Element titleElement=source.getElementById("content");
		if (titleElement==null)
			 titleElement=source.getElementById("main");
		if (titleElement==null)
			 titleElement=source.getElementById("post");
