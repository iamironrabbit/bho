...
public class BookReadingErrorActivity extends Activity implements ErrorKeys {
	...
	protected void onCreate(Bundle bundle) {
		...
		final BhoTextView textView = (BhoTextView)findViewById(R.id.error_book_reading_text);
		textView.setText(getIntent().getStringExtra(MESSAGE));

		final View buttonView = findViewById(R.id.error_book_reading_buttons);
		final ZLResource buttonResource = ZLResource.resource("dialog").getResource("button");

		final BhoButton okButton = (BhoButton)buttonView.findViewById(R.id.ok_button);
		...
		final BhoButton cancelButton = (BhoButton)buttonView.findViewById(R.id.cancel_button);
