...
class LibraryTreeAdapter extends TreeAdapter {
	...
	private View createView(View convertView, ViewGroup parent, LibraryTree tree) {
		...
		((BhoTextView)view.findViewById(R.id.library_tree_item_name)).setText(tree.getName());
		((BhoTextView)view.findViewById(R.id.library_tree_item_childrenlist)).setText(tree.getSummary());
		return view;
	}
