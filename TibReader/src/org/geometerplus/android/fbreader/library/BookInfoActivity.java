...
public class BookInfoActivity extends Activity {
	...
	private BhoButton findButton(int buttonId) {
		return (BhoButton)findViewById(buttonId);
	}

	private void setupButton(int buttonId, String resourceKey, View.OnClickListener listener) {
		final ZLResource buttonResource = ZLResource.resource("dialog").getResource("button");
		final BhoButton button = findButton(buttonId);
	...
	private void setupInfoPair(int id, String key, CharSequence value, int param) {
		...
		((BhoTextView)layout.findViewById(R.id.book_info_key)).setText(myResource.getResource(key).getValue(param));
		((BhoTextView)layout.findViewById(R.id.book_info_value)).setText(value);
	}
	...
	private void setupBookInfo(Book book) {
		((BhoTextView)findViewById(R.id.book_info_title)).setText(myResource.getResource("bookInfo").getValue());
	...
	private void setupAnnotation(Book book) {
		final BhoTextView titleView = (BhoTextView)findViewById(R.id.book_info_annotation_title);
		final BhoTextView bodyView = (BhoTextView)findViewById(R.id.book_info_annotation_body);
	...
	private void setupFileInfo(Book book) {
		((BhoTextView)findViewById(R.id.file_info_title)).setText(myResource.getResource("fileInfo").getValue());
