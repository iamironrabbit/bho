...
public class BuyBooksActivity extends Activity implements NetworkLibrary.ChangeListener {
	...
	private void setupUIInternal(AuthorizationState state) {
		...
		final BhoTextView textArea = (BhoTextView)findViewById(R.id.buy_book_text);
		final BhoButton okButton =
			(BhoButton)findViewById(R.id.buy_book_buttons).findViewById(R.id.ok_button);
		final BhoButton cancelButton =
			(BhoButton)findViewById(R.id.buy_book_buttons).findViewById(R.id.cancel_button);
