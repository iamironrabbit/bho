...
public class AddCustomCatalogActivity extends Activity {
	...
	private String getTextById(int id) {
		final String text = ((BhoTextView)findViewById(id)).getText().toString();
		return text != null ? text.trim() : null;
	}

	private void setupButton(int id, String resourceKey, View.OnClickListener listener) {
		final BhoButton button =
			(BhoButton)findViewById(R.id.add_custom_catalog_buttons).findViewById(id);
		button.setText(
	...
	private void setErrorText(final String errorText) {
		runOnUiThread(new Runnable() {
			public void run() {
				final BhoTextView errorView = (BhoTextView)findViewById(R.id.add_custom_catalog_error);
				if (errorText != null) {
