...
*/
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo) {
        ...
        if (chatSelected) {
            ...
            //TODO .setIcon(org.ironrabbit.tbchat.app.internal.R.drawable.ic_menu_end_conversation)
            ...
            if (allowBlock) {
                ...
                //.setIcon(org.ironrabbit.tbchat.app.internal.R.drawable.ic_menu_block)
                        .setOnMenuItemClickListener(mContextMenuHandler);
            }
        } else if (contactSelected) {
            menu.add(0, MENU_START_CONVERSATION, 0, menu_start_conversation)
            //.setIcon(org.ironrabbit.tbchat.app.internal.R.drawable.ic_menu_start_conversation)
                    .setOnMenuItemClickListener(mContextMenuHandler);
            menu.add(0, MENU_VIEW_PROFILE, 0, menu_view_profile)
