...
public class Imps {
    ...
    public static final class Provider implements BaseColumns, ProviderColumns {
        ...
        public static final Uri CONTENT_URI = Uri
                .parse("content://org.ironrabbit.tbchat.app.im.provider.Imps/providers");

        public static final Uri CONTENT_URI_WITH_ACCOUNT = Uri
                .parse("content://org.ironrabbit.tbchat.app.im.provider.Imps/providers/account");

        /**
         * The MIME type of {@link #CONTENT_URI} providing a directory of
         * people.
         */
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/bo-imps-providers";

        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/bo-imps-providers";
    ...
    public static final class Account implements BaseColumns, AccountColumns {
        ...
        /** The content:// style URL for this table */
        public static final Uri CONTENT_URI = Uri
                .parse("content://org.ironrabbit.tbchat.app.im.provider.Imps/accounts");

        /**
         * The MIME type of {@link #CONTENT_URI} providing a directory of
         * account.
         */
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/bo-imps-accounts";

        /**
         * The MIME type of a {@link #CONTENT_URI} subdirectory of a single
         * account.
         */
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/bo-imps-accounts";
    ...
    public static final class AccountStatus implements BaseColumns, AccountStatusColumns {
        /** The content:// style URL for this table */
        public static final Uri CONTENT_URI = Uri
                .parse("content://org.ironrabbit.tbchat.app.im.provider.Imps/accountStatus");

        /**
         * The MIME type of {@link #CONTENT_URI} providing a directory of
         * account status.
         */
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/bo-imps-account-status";

        /**
         * The MIME type of a {@link #CONTENT_URI} subdirectory of a single
         * account status.
         */
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/bo-imps-account-status";
    ...
    public static final class Contacts implements BaseColumns, ContactsColumns, PresenceColumns,
        ...
        /** The content:// style URL for this table */
        public static final Uri CONTENT_URI = Uri
                .parse("content://org.ironrabbit.tbchat.app.im.provider.Imps/contacts");

        /** The content:// style URL for contacts joined with presence */
        public static final Uri CONTENT_URI_WITH_PRESENCE = Uri
                .parse("content://org.ironrabbit.tbchat.app.im.provider.Imps/contactsWithPresence");
        ...
        public static final Uri CONTENT_URI_ONLINE_CONTACTS_BY = Uri
                .parse("content://org.ironrabbit.tbchat.app.im.provider.Imps/contacts/online");
        ...
        public static final Uri CONTENT_URI_OFFLINE_CONTACTS_BY = Uri
                .parse("content://org.ironrabbit.tbchat.app.im.provider.Imps/contacts/offline");

        /** The content:// style URL for operations on bulk contacts */
        public static final Uri BULK_CONTENT_URI = Uri
                .parse("content://org.ironrabbit.tbchat.app.im.provider.Imps/bulk_contacts");
        ...
        public static final Uri CONTENT_URI_ONLINE_COUNT = Uri
                .parse("content://org.ironrabbit.tbchat.app.im.provider.Imps/contacts/onlineCount");

        /**
         * The MIME type of {@link #CONTENT_URI} providing a directory of
         * people.
         */
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/bo-imps-contacts";

        /**
         * The MIME type of a {@link #CONTENT_URI} subdirectory of a single
         * person.
         */
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/bo-imps-contacts";
    ...
    public static final class ContactList implements BaseColumns, ContactListColumns {
        ...
        /** The content:// style URL for this table */
        public static final Uri CONTENT_URI = Uri
                .parse("content://org.ironrabbit.tbchat.app.im.provider.Imps/contactLists");

        /**
         * The MIME type of {@link #CONTENT_URI} providing a directory of
         * people.
         */
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/bo-imps-contactLists";

        /**
         * The MIME type of a {@link #CONTENT_URI} subdirectory of a single
         * person.
         */
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/bo-imps-contactLists";
    ...
    public static final class BlockedList implements BaseColumns, BlockedListColumns {
        ...
        /** The content:// style URL for this table */
        public static final Uri CONTENT_URI = Uri
                .parse("content://org.ironrabbit.tbchat.app.im.provider.Imps/blockedList");

        /**
         * The MIME type of {@link #CONTENT_URI} providing a directory of
         * people.
         */
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/bo-imps-blockedList";

        /**
         * The MIME type of a {@link #CONTENT_URI} subdirectory of a single
         * person.
         */
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/bo-imps-blockedList";
    ...
    public static final class ContactsEtag implements BaseColumns, ContactsEtagColumns {
        ...
        /** The content:// style URL for this table */
        public static final Uri CONTENT_URI = Uri
                .parse("content://org.ironrabbit.tbchat.app.im.provider.Imps/contactsEtag");

        /**
         * The MIME type of {@link #CONTENT_URI} providing a directory of
         * people.
         */
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/bo-imps-contactsEtag";

        /**
         * The MIME type of a {@link #CONTENT_URI} subdirectory of a single
         * person.
         */
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/bo-imps-contactsEtag";
    }
    ...
    public static final class Messages implements BaseColumns, MessageColumns {
        ...
        /** The content:// style URL for this table */
        public static final Uri CONTENT_URI = Uri
                .parse("content://org.ironrabbit.tbchat.app.im.provider.Imps/messages");

        /** The content:// style URL for messages by thread id */
        public static final Uri CONTENT_URI_MESSAGES_BY_THREAD_ID = Uri
                .parse("content://org.ironrabbit.tbchat.app.im.provider.Imps/messagesByThreadId");
        ...
        public static final Uri OTR_MESSAGES_CONTENT_URI_BY_THREAD_ID = Uri
                .parse("content://org.ironrabbit.tbchat.app.im.provider.Imps/otrMessagesByThreadId");
        ...
        public static final Uri OTR_MESSAGES_CONTENT_URI_BY_ACCOUNT_AND_CONTACT = Uri
                .parse("content://org.ironrabbit.tbchat.app.im.provider.Imps/otrMessagesByAcctAndContact");
        ...
        public static final Uri OTR_MESSAGES_CONTENT_URI_BY_PROVIDER = Uri
                .parse("content://org.ironrabbit.tbchat.app.im.provider.Imps/otrMessagesByProvider");
        ...
        public static final Uri OTR_MESSAGES_CONTENT_URI_BY_ACCOUNT = Uri
                .parse("content://org.ironrabbit.tbchat.app.im.provider.Imps/otrMessagesByAccount");

        public static final Uri OTR_MESSAGES_CONTENT_URI_BY_PACKET_ID = Uri
                .parse("content://org.ironrabbit.tbchat.app.im.provider.Imps/otrMessagesByPacketId");

        /**
         * The MIME type of {@link #CONTENT_URI} providing a directory of
         * people.
         */
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/bo-imps-messages";

        /**
         * The MIME type of a {@link #CONTENT_URI} subdirectory of a single
         * person.
         */
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/bo-imps-messages";
    ...
    public final static class GroupMembers implements GroupMemberColumns {
        ...
        public static final Uri CONTENT_URI = Uri
                .parse("content://org.ironrabbit.tbchat.app.im.provider.Imps/groupMembers");

        /**
         * The MIME type of {@link #CONTENT_URI} providing a directory of group
         * members.
         */
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/bo-imps-groupMembers";

        /**
         * The MIME type of a {@link #CONTENT_URI} subdirectory of a single
         * group member.
         */
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/bo-imps-groupMembers";
    }
    ...
    public final static class Invitation implements InvitationColumns, BaseColumns {
        ...
        /** The content:// style URL for this table */
        public static final Uri CONTENT_URI = Uri
                .parse("content://org.ironrabbit.tbchat.app.im.provider.Imps/invitations");

        /**
         * The MIME type of {@link #CONTENT_URI} providing a directory of
         * invitations.
         */
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/bo-imps-invitations";

        /**
         * The MIME type of a {@link #CONTENT_URI} subdirectory of a single
         * invitation.
         */
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/bo-imps-invitations";
    }
    ...
    public static final class Avatars implements BaseColumns, AvatarsColumns {
        ...
        /** The content:// style URL for this table */
        public static final Uri CONTENT_URI = Uri
                .parse("content://org.ironrabbit.tbchat.app.im.provider.Imps/avatars");

        /**
         * The content:// style URL for avatars by provider, account and contact
         */
        public static final Uri CONTENT_URI_AVATARS_BY = Uri
                .parse("content://org.ironrabbit.tbchat.app.im.provider.Imps/avatarsBy");

        /** The MIME type of {@link #CONTENT_URI} providing the avatars */
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/bo-imps-avatars";

        /** The MIME type of a {@link #CONTENT_URI} */
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/bo-imps-avatars";
    ...
    public static final class Presence implements BaseColumns, PresenceColumns {
        /** The content:// style URL for this table */
        public static final Uri CONTENT_URI = Uri
                .parse("content://org.ironrabbit.tbchat.app.im.provider.Imps/presence");

        /** The content URL for IM presences for an account */
        public static final Uri CONTENT_URI_BY_ACCOUNT = Uri
                .parse("content://org.ironrabbit.tbchat.app.im.provider.Imps/presence/account");

        /** The content:// style URL for operations on bulk contacts */
        public static final Uri BULK_CONTENT_URI = Uri
                .parse("content://org.ironrabbit.tbchat.app.im.provider.Imps/bulk_presence");
        ...
        public static final Uri SEED_PRESENCE_BY_ACCOUNT_CONTENT_URI = Uri
                .parse("content://org.ironrabbit.tbchat.app.im.provider.Imps/seed_presence/account");

        /**
         * The MIME type of a {@link #CONTENT_URI} providing a directory of
         * presence
         */
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/bo-imps-presence";
    ...
    public static final class Chats implements BaseColumns, ChatsColumns {
        ...
        /** The content:// style URL for this table */
        public static final Uri CONTENT_URI = Uri
                .parse("content://org.ironrabbit.tbchat.app.im.provider.Imps/chats");

        /** The content URL for all chats that belong to the account */
        public static final Uri CONTENT_URI_BY_ACCOUNT = Uri
                .parse("content://org.ironrabbit.tbchat.app.im.provider.Imps/chats/account");

        /**
         * The MIME type of {@link #CONTENT_URI} providing a directory of chats.
         */
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/bo-imps-chats";

        /**
         * The MIME type of a {@link #CONTENT_URI} subdirectory of a single
         * chat.
         */
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/bo-imps-chats";
    ...
    public static class SessionCookies implements SessionCookiesColumns, BaseColumns {
        ...
        public static final Uri CONTENT_URI = Uri
                .parse("content://org.ironrabbit.tbchat.app.im.provider.Imps/sessionCookies");
        ...
        public static final Uri CONTENT_URI_SESSION_COOKIES_BY = Uri
                .parse("content://org.ironrabbit.tbchat.app.im.provider.Imps/sessionCookiesBy");

        /**
         * The MIME type of {@link #CONTENT_URI} providing a directory of
         * people.
         */
        public static final String CONTENT_TYPE = "vnd.android-dir/bo-imps-sessionCookies";
    }
    ...
    public static class ProviderSettings implements ProviderSettingsColumns {
        ...
        /** The content:// style URI for this table */
        public static final Uri CONTENT_URI = Uri
                .parse("content://org.ironrabbit.tbchat.app.im.provider.Imps/providerSettings");

        /** The MIME type of {@link #CONTENT_URI} providing provider settings */
        public static final String CONTENT_TYPE = "vnd.android-dir/bo-imps-providerSettings";
        ...
        public static class QueryMap extends ContentQueryMap {
            ...
            public String getXmppResource() {
                return getString(XMPP_RESOURCE, "Mobile");
            }
    ...
    public static final class BrandingResourceMapCache implements BaseColumns,
        ...
        /** The content:// style URL for this table. */
        public static final Uri CONTENT_URI = Uri
                .parse("content://org.ironrabbit.tbchat.app.im.provider.Imps/brandingResMapCache");
    }
    ...
    public static final class OutgoingRmq implements BaseColumns, OutgoingRmqColumns {
        ...
        /** The content:// style URL for this table. */
        public static final Uri CONTENT_URI = Uri
                .parse("content://org.ironrabbit.tbchat.app.im.provider.Imps/outgoingRmqMessages");
        ...
        public static final Uri CONTENT_URI_FOR_HIGHEST_RMQ_ID = Uri
                .parse("content://org.ironrabbit.tbchat.app.im.provider.Imps/outgoingHighestRmqId");
    ...
    public static final class LastRmqId implements BaseColumns, LastRmqIdColumns {
        ...
        /** The content:// style URL for this table. */
        public static final Uri CONTENT_URI = Uri
                .parse("content://org.ironrabbit.tbchat.app.im.provider.Imps/lastRmqId");
    }
    ...
    public static final class ServerToDeviceRmqIds implements BaseColumns,
        ...
        /** The content:// style URL for this table. */
        public static final Uri CONTENT_URI = Uri
                .parse("content://org.ironrabbit.tbchat.app.im.provider.Imps/s2dids");
    }
