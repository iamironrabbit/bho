...
import org.ironrabbit.tbchat.app.im.app.NewChatActivity;
...
public class StatusBarNotifier {
    ...
    public void notifyChat(long providerId, long accountId, long chatId, String username,
        ...
        intent.addCategory(org.ironrabbit.tbchat.app.im.app.ImApp.IMPS_CATEGORY);
    ...
    class NotificationInfo {
        ...
        public Notification createNotification(String tickerText, boolean lightWeightNotify) {
            Notification notification = new Notification(R.drawable.ic_stat_tbchatnotify,
