...
package org.ironrabbit.tbchat.app.im.service;

import org.ironrabbit.tbchat.IOtrKeyManager;
import org.ironrabbit.tbchat.app.im.IConnectionCreationListener;
import org.ironrabbit.tbchat.app.im.IImConnection;
import org.ironrabbit.tbchat.app.im.IRemoteImService;

import org.ironrabbit.tbchat.OtrChatManager;
import org.ironrabbit.tbchat.OtrKeyManagerAdapter;
import org.ironrabbit.tbchat.R;
import org.ironrabbit.tbchat.app.NetworkConnectivityListener;
import org.ironrabbit.tbchat.app.NetworkConnectivityListener.State;
import org.ironrabbit.tbchat.app.im.app.ImPluginHelper;
import org.ironrabbit.tbchat.app.im.app.LandingPage;
import org.ironrabbit.tbchat.app.im.engine.ConnectionFactory;
import org.ironrabbit.tbchat.app.im.engine.ImConnection;
import org.ironrabbit.tbchat.app.im.engine.ImException;
import org.ironrabbit.tbchat.app.im.engine.HeartbeatService.Callback;
import org.ironrabbit.tbchat.app.im.plugin.ImPluginInfo;
...
public class RemoteImService extends Service implements OtrEngineListener {
    ...
    private static final String TAG = "TbChat.ImService";
    ...
    private void startForegroundCompat() {
        ...
        notification.setLatestEventInfo(this, getString(R.string.im_label), "Active.", notification.contentIntent);
