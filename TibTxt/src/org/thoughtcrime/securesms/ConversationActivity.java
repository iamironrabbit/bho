...
import org.ironrabbit.type.TibojiManager.Tiboji;
...
public class ConversationActivity extends SherlockFragmentActivity
  ...
  private ImageButton tibojiButton;
  ...
  private void initializeResources() {
    ...
    tibojiButton		= (ImageButton)findViewById(R.id.tiboji_button);
    ...
    tibojiButton.setOnClickListener(new TibojiButtonListener());
  ...
  private class TibojiButtonListener implements OnClickListener {

	  QuickAction mQuickAction 	= null;
	  
	  public TibojiButtonListener ()
	  {
		  super ();
		  initQuickAction();
	  }
	  ...
	  {
		  mQuickAction = new QuickAction(ConversationActivity.this);
		  
		  Iterator<Entry<String,Tiboji>> it = TibojiManager.getInstance(ConversationActivity.this).getTiboji();
		  int i = 0;
		  while (it.hasNext())
		  {
