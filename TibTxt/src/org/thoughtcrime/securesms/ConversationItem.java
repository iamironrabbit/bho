...
public class ConversationItem extends LinearLayout {
  ...
  private void setBodyText(MessageRecord messageRecord, String body) {
    ...
    {
    	Log.e("setBodyText",e.getLocalizedMessage(),e);
    }
  }
  ...
  private String showTiboji (String body)
  {
	  ...
	  LinearLayout v = (LinearLayout)findViewById(R.id.tiboji_layout);
	  v.removeAllViews();
	  String result = body;
